          ...
          {contents.map((element, index) => {
            return (
              <Row style={{ marginBottom: 16 }} gutter={16}>
                <Col span={6}>
                  <Input type="number" onChange={e => this.handleStartChange(e, index)} value={element.start} disabled />
                </Col>
                <Col span={5}>{this.renderRelation(index, element, contents)}</Col>
                <Col span={6}>
                  {index !== contents.length - 1 && (
                    <Input type="number" disabled={disabled} onChange={e => this.handleEndChange(e, index)} value={element.end} />
                  )}
                </Col>
                <Col span={6}>
                  <Input
